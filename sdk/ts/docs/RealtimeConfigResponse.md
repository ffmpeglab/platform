...
```typescript
import type { RealtimeConfigResponse } from 'ffmpeglab-platform-sdk'
...
} satisfies RealtimeConfigResponse
...
const exampleParsed = JSON.parse(exampleJSON) as RealtimeConfigResponse
