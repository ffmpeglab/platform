...
`nimbusOauthEmailOptional` | boolean
...
`samlAllowEncryptedAssertions` | boolean
...
`customOauthMaxProviders` | number
...
const example = {
  ...
  "samlAllowEncryptedAssertions": null,
...
const exampleParsed = JSON.parse(exampleJSON) as AuthConfigResponse
